...
ball_images = [
    pygame.image.load(os.path.join(image_path, "balloon11.png")),
    pygame.image.load(os.path.join(image_path, "balloon22.png")),
    pygame.image.load(os.path.join(image_path, "balloon33.png")),
    pygame.image.load(os.path.join(image_path, "balloon44.png"))]
...
balls.append({
    ...
    "to_x" : 3, # X 축 이동방향, -3이면 왼쪽, +3이면 오른쪽으로 이동
    "to_y" : -6, # y축 이동 방향
    "init_spd_y" : ball_speed_y[0]}) # y 최초 속도(뜅겨서 바운스 되는)
...
# 공 위치 정의
    ...
    # 가로벽에 닿았을때 공 이동 위치 변경(튕김 반영)
      ...
      # 세로 위치
        ...
        else: # 그 외 속도는 줄여나감(위로는 -값, 아래는 + 값 그래야 포물선 효과를 냄)
            ball_val["to_y"] += 0.5
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    balls.append({
                        ...
                        "to_x" : -3, # X 축 이동방향, -3이면 왼쪽, +3이면 오른쪽으로 이동
                        "to_y" : -6, # y축 이동 방향
                        "init_spd_y" : ball_speed_y[ball_img_idx +1]}) # y 최초 속도(뜅겨서 바운스 되는)
